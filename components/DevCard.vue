...
<!-- Page Container -->
    <section id="DevCard">
     <div class="flex items-center justify-center bg-white py-48">
                ...
                <div class="container max-w-7xl px-4">
                    ...
                    <div class="flex flex-wrap justify-center text-center mb-24">
                        <div class="w-full lg:w-6/12 px-4">
                            <!-- Header -->
                            <h1 class="text-gray-900 text-5xl font-bold mb-8 text-glow">
                                ทีมผู้พัฒนา
                            </h1>

                            <!-- Description -->
                            <p class="text-gray-700 text-lg font-light text-glow">
                                ทีมงานผู้พัฒนาของบอท Discord MMO
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        <!-- Member #1 -->
                        <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4 hover:scale-110 duration-300">
                            <div class="flex flex-col">
                                <!-- Avatar -->
                                <a href="#" class="mx-auto">
                                    <img class="rounded-2xl drop-shadow-md hover:drop-shadow-xl transition-all duration-200 delay-100"
                                        src="https://i.pinimg.com/originals/3e/a7/6e/3ea76e89e003a1d92c93d6682a2be717.png"/>
                                </a>
...
.text-glow {
  text-shadow: 0 0 120px rgba(170, 238, 13, 0.75), 0 0 32px rgb(65 120 255 / 24%);
}
